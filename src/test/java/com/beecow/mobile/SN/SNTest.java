...
public class SNTest extends BaseTest {
    ...
    public void SN_01() throws Exception, TestLinkAPIException {
        ...
        try{
            ...
            TestLink.updateResult(Testlink_ProjectName,Testlink_TestPlanName, "TCSN-1", Testlink_BuildName, null, TestLinkAPIResults.TEST_PASSED);
        }catch (TestLinkAPIException ex){
            System.out.print("Can't update result to Testlink for TCSN_1");
        }
        catch (Exception ex) {
            //Test failed
            ...
            TestLink.updateResult(Testlink_ProjectName, Testlink_TestPlanName, "TCSN-1", Testlink_BuildName, null, TestLinkAPIResults.TEST_FAILED);
    ...
    public void selectFirstSecondLaunchingAndGoToProfilePage() {
        ...
        homeScreen.clickProfileTabView();
    }
}
